...
- Fixed broken syntax in middleware section that prevented compilation.
...
- All persona tools (`persona_list`, `persona_activate`, `persona_create`,
  `persona_current`, `persona_deactivate`) continue to work

## [1.0.0] — 2026-06-15

### Added

- Initial plugin scaffold with 5 persona tools and 5 built-in personas
